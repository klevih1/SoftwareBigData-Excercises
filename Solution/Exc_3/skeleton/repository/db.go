...
func prepopulate(dbConn *gorm.DB) error {
	...
	// todo create drinks
	drinks := []model.Drink{
		{Name: "Coca Cola", Price: 2.5, Description: "Refreshing soda"},
		{Name: "Fanta", Price: 2.3, Description: "Orange flavored soda"},
		{Name: "Water", Price: 1.0, Description: "Still water"},
		{Name: "Espresso", Price: 1.8, Description: "Strong coffee shot"},
	}
